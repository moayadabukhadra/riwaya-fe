        ...
        <div className={"row align-items-start"}>
            ...
            <div className={"d-flex flex-column gap-2 ms-3 col-12 col-md-7"}>
                ...
                <div className={"mt-2 row align-items-center justify-content-center justify-content-lg-start gap-1"}>
                    <a download={book.file} href={"https://154.38.175.203/api/book/download/" + book.id}
                                        ...
                                        <div className={"d-flex flex-column border rounded-2  p-2"}>
                                            <div className={"d-flex align-items-center justify-content-between"}>
                                                <div className={"d-flex align-items-start"}>
                                                    <img
                                                        src={comment.user?.image ? "https://154.38.175.203/storage/images/" + comment.user?.image.path : "/images/placeholders/user-placeholder.png"}
                                                            ...
                                                            return (
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div className={"d-flex align-items-start"}>
                                                                            <img
                                                                                src={reply.user?.image ? "https://154.38.175.203/storage/images/" + reply.user?.image.path : "/images/placeholders/user-placeholder.png"}
                                                                                alt={reply.user?.name}
