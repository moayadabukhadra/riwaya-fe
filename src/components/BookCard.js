    ...
    return (
        <a  href={'/books/?book=' + book.id} className="mb-5">
            <div className="card text-white card-has-bg click-col"
                 style={{backgroundImage: `url(${book.image ? "https://154.38.175.203/storage/images/" + book.image.path : "/images/placeholders/placeholder.jpg"})`}}>
                        ...
                        <a href={"/authors?author=" + book.author.id}
                           className="d-flex gap-1 align-items-center text-decoration-none">
                            <img className="mr-3 rounded-circle"
                                 src={book.author.image ? "https://154.38.175.203/storage/images/" + book.author.image.path : "/images/placeholders/placeholder.jpg"}
