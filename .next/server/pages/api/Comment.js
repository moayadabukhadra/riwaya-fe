...
const addComment = (bookId, comment)=>{
    return _index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post(`${path}/add/${bookId}`, comment);
};
...
var __webpack_exports__ = __webpack_require__.X(0, [950], () => (__webpack_exec__(5458)));
