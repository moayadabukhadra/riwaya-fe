...
const getUserBookmarks = ()=>{
    return _index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.get("bookmarks");
};
const storeBookmark = (data)=>{
    return _index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post(`${path}/store/${data.bookId}/${data.bookmark_type}`);
};
const getBookmarkStatus = (bookId)=>{
    return _index__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.get(`${path}/status/${bookId}`);
};
...
var __webpack_exports__ = __webpack_require__.X(0, [950], () => (__webpack_exec__(3702)));
